...
styles_info = [
    ...
    },
    {
        ...
        "styles": [{"name": "ノーマル", "id": 9}, {"name": "クイーン", "id": 65}],
        "version": "0.14.5",
    },
    {
        "supported_features": {"permitted_synthesis_morphing": "ALL"},
    ...
    },
    {
        ...
        "styles": [{"name": "ノーマル", "id": 20}, {"name": "セクシー／あん子", "id": 66}],
        "version": "0.14.5",
    },
    {
        "supported_features": {"permitted_synthesis_morphing": "ALL"},
...
async def audio_query(text, speaker):
    ...
    async with aiohttp.ClientSession() as session:
        async with session.post(
            "http://localhost:50021/audio_query", headers=headers, params=query_payload
        ) as response:
...
@bot.command(name="style", help="使用するスタイルIDを設定します。")
